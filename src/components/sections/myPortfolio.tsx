...
const MyPortfolioSection: React.FC = () => {
    return (
        <section className="flex flex-col items-start justify-end bg-black gap-y-6 h-dvh w-dvh">
            <div className="flex flex-row justify-between w-full my-2">
                <h1 className="text-4xl font-semibold text-gray-300 text-start">My Portfolio</h1>
